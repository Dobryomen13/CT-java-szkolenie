...
//Utworzyć metodę, której zadaniem jest wyświetlenie tekstu podanego jako parametr
    ...
    public Basics(final String tekst) {
        this.tekst2 = tekst;
        // this.tekst2 - poprzez slowko this odwolujemy sie do parametru klasy
        // tekst - jest to wykorzystanie parametru konstruktora
        // inaczej do parametru klasy ustawiana jest wartosc z parametru konstruktora
        //tzn parametrKlasy=parametrKonstruktora this.tekst2 = tekst
    }
